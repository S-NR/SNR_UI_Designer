...
void MX_GPIO_Init(void)
{
  ...
  /* STM32H735G-DK: Release LCD from Reset first */
  HAL_GPIO_WritePin(GPIOH, LCD_RST_Pin, GPIO_PIN_SET);
  HAL_Delay(10);  /* Wait 10ms for LCD to initialize after reset */
  
  /* STM32H735G-DK: Enable LCD Display Controller */
  HAL_GPIO_WritePin(GPIOD, LCD_DISP_Pin, GPIO_PIN_SET);
  HAL_Delay(10);  /* Wait 10ms for display enable */
  
  /* STM32H735G-DK: Turn ON LCD Backlight */
  HAL_GPIO_WritePin(GPIOG, LCD_BL_CTRL_Pin, GPIO_PIN_SET);
